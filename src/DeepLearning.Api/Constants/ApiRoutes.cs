namespace DeepLearning.Api.Constants
{
    public static class ApiRoutes
    {
        ...
        public static class FollowUpThreads
        {
            public const string Base = $"{Prefix}/follow-up-threads";
        }
        ...
        {
            public const string Base = $"{Prefix}/progress";
        }
        ...
        {
            public const string Base = $"{Prefix}/admin/users";
        }
    }
}
