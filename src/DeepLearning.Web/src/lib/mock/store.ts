...
export async function generateDeepLearning(
  ...
  const content: DeepLearningContent = {
    questionId,
    referenceTitle: q?.taskType === 1 ? "中央大道路面翻修通知" : "社区健康中心流感疫苗接种通知",
    referenceText:
      q?.taskType === 1
...
const reviewVocab: ReviewVocabItem[] = [
  {
    ...
    englishExpr: "walk-in slots",
    chineseEquiv: "现场名额",
    accumulatedSemantics:
      "无需预约、当场取号即可就诊的名额;医疗 / 政务窗口公告常用。不可逐字直译为「走进的位置」。",
    category: "固定搭配",
    domain: "医疗健康",
    scenario: "公告通知",
    frequencyTag: "中频",
  ...
  },
  {
    ...
    chineseEquiv: "调解会议",
    accumulatedSemantics:
      "劳资 / 民事纠纷进入正式聆讯前,由调解员主持的和解会议。规范译名,勿译成「和解大会」。",
    category: "专业术语",
    domain: "法律政务",
    scenario: "信函往来",
    frequencyTag: "低频",
  ...
  {
    id: "rv-3",
    englishExpr: "instalment",
    chineseEquiv: "分期款 / 期",
    accumulatedSemantics:
      "① 分期付款中的一期(in six equal monthly instalments = 分六期等额按月偿付)。② 连载作品的一集 / 一辑 —— 语境不同,勿混用。",
    category: "易混词",
    domain: "法律政务",
    scenario: "信函往来",
    frequencyTag: "中频",
  ...
  },
  {
    ...
    accumulatedSemantics: "银行 / 支付语境:持卡人未同意而发生的扣款。固定搭配,notice 里高频。",
    category: "固定搭配",
    domain: "商务财经",
    scenario: "信函往来",
    frequencyTag: "高频",
  ...
  },
  {
    ...
    chineseEquiv: "路面翻修工程",
    accumulatedSemantics: "市政公告:重铺路面沥青层的施工。works 此处指「工程」,不是「作品」。",
    category: "专业术语",
    domain: "法律政务",
    scenario: "公告通知",
    frequencyTag: "中频",
