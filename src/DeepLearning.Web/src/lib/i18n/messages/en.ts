...
const en = {
  ...
  "admin.roleChangeConfirmTitle": "Change role?",
  "admin.roleChangeConfirmDescription": "{email}'s role will change from \"{from}\" to \"{to}\".",
  "admin.lastAdminError": "At least one admin is required — you can't demote the only admin to user.",
